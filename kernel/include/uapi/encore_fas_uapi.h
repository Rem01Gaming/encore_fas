...
#define FAS_IOC_UPDATE_LIBGUI_OFFSET \
	_IOW(FAS_IOC_MAGIC, 1, struct fas_libgui_offset)
#define FAS_IOC_GET_LIBGUI_OFFSET \
	_IOR(FAS_IOC_MAGIC, 2, struct fas_libgui_offset)
#define FAS_IOC_REGISTER_LISTENER \
	_IOWR(FAS_IOC_MAGIC, 3, struct fas_register_args)
#define FAS_IOC_REMOVE_LISTENER _IOW(FAS_IOC_MAGIC, 4, struct fas_remove_args)
#define FAS_IOC_HINT_FRAMETIME _IOW(FAS_IOC_MAGIC, 5, struct fas_frametime_hint)
#define FAS_IOC_SET_TARGET_FPS_LIST \
	_IOW(FAS_IOC_MAGIC, 6, struct fas_target_fps_list)
